...
the [batch table hierarchy extension of 3D Tiles](https://archive.softwareheritage.org/browse/directory/657e37e75fcc50bc0fc4e8fbb20adb6a88149a1d/?origin=https://github.com/AnalyticalGraphicsInc/3d-tiles)).
...
mapping from _Gen4DCity_ thanks to the abstract modelling work done in section 3.
...
core specification. [Figure 3.6](#Figure_3_6) is a proposition of description of these concepts.
...
this chapter. We start with a presentation of the software architecture (section 3.3.1).
We continue with an evaluation of our propositions in comparison with existing
standards (section 3.3.2). We finish with the proposition of visualization rules for
urban evolution visualization and apply them for the visualization of a time-evolving
3D city model (section 3.3.3).
...
software architecture of this prototype is represented in [figure 3.7.](#figure_3_7) In this section,
...
two processes respectively allowing to create 3D city models in 3D Tiles ( [City Tiler](https://archive.softwareheritage.org/swh:1:cnt:3fe3b38bf74758e1ac649e16d05c3c11f09076d4;origin=https://github.com/VCityTeam/py3dtiles/) )
and time-evolving 3D city models in 3D Tiles extended with 3DTiles_temporal
( [City Temporal Tiler](https://archive.softwareheritage.org/swh:1:cnt:e9fca4145806c85d1ab4eec05cba628311fd3370;origin=https://github.com/VCityTeam/py3dtiles/) ). The City Tiler process allows to go from a 3DCityDB database
...
steps allowing to compute the graph of transactions are fully detailed in section 5.1.
This implementation is currently available on a specific version of [py3dtiles](https://archive.softwareheritage.org/swh:1:rev:39b23180b47ed3b995aeb5b8fa45aff56b88d353;origin=https://github.com/VCityTeam/py3dtiles/). They
...
server ( Apache in our case) and can be visualized in the [UD-Viz](https://archive.softwareheritage.org/swh:1:rev:b5a523825862a3f2dd440c2922485cdd30009834;origin=https://github.com/VCityTeam/UD-Viz/) web client. UD-Viz
allows to visualize, analyze and interact with geographic data (3D city models,
vectorial resources, maps, etc.). It is based on [iTowns](https://archive.softwareheritage.org/swh:1:rev:e996369f1da742b8ca923f4c64d656f8d1a537db;origin=https://github.com/iTowns/itowns) , a framework for visualizing
...
section 3.3.3 for screenshots and for an example use case). The City Object module
...
are currently available on specific versions of [UD-Viz](https://archive.softwareheritage.org/swh:1:rev:e915ff94f9902fa0def310e159beb3caf461ab59;origin=https://github.com/jailln/UDV/) and of [iTowns](https://archive.softwareheritage.org/swh:1:snp:1f61a61af2dc46834e108c586373f043defcd687;origin=https://github.com/jailln/itowns//). They are
...
implemented into other software components supporting 3D Tiles (e.g. [Cesium](https://cesiumjs.org/) ).
