...
* FIXME: the retieved tiles seem to come from the [a model provided to the TemporalProvider instantiation](https://github.com/VCityTeam/UD-Viz/blob/master/src/Widgets/Temporal/TemporalModule.js#L24) that is typed as being a [$3DTemporalExtension](https://github.com/VCityTeam/UD-Viz/blob/master/src/Widgets/Temporal/TemporalModule.js#L21) (that is [defined here](https://github.com/VCityTeam/UD-Viz/blob/master/src/Widgets/Temporal/Model/3DTemporalExtension.js#L9))
