#!/bin/bash
# This script downloads the designated CityGML data file from Lyon
# Metropole open data repository and when necessary applies some
# ad-hoc fixes on well known inconsitancies.
